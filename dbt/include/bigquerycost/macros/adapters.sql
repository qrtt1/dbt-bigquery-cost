...
{% macro bigquerycost__alter_column_type(relation,column_name,new_column_type) -%}
...
{% macro bigquerycost__check_schema_exists(information_schema,schema) -%}
...
{% macro bigquerycost__create_schema(relation) -%}
...
{% macro bigquerycost__drop_relation(relation) -%}
...
{% macro bigquerycost__drop_schema(relation) -%}
...
{% macro bigquerycost__get_columns_in_relation(relation) -%}
...
{% macro bigquerycost__list_relations_without_caching(schema_relation) -%}
'''creates a table of relations withough using local caching.'''
{% endmacro %}

{% macro bigquerycost__list_schemas(database) -%}
...
{% macro bigquerycost__rename_relation(from_relation, to_relation) -%}
...
{% macro bigquerycost__truncate_relation(relation) -%}
...
{% macro bigquerycost__current_timestamp() -%}
